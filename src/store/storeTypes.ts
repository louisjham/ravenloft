...
export interface TokenSlice {
  ...
  searchToken: (tokenId: string) => import('../game/types').TokenSearchResult | null;
  getTokensOnTile: (tileId: string) => import('../game/types').GameToken[];
  canSearchTokens: (heroId: string) => { canSearch: boolean; reason: string; tokens: import('../game/types').GameToken[] };
