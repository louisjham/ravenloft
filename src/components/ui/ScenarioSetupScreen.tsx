  ...
  return (
    <div className="setup-screen" style={{
      ...
      <div className="setup-header" style={{ textAlign: 'center', marginBottom: '40px' }}>
        <h1 className="gothic-title" style={{ fontSize: '3.5rem', margin: 0, color: 'var(--color-gold)' }}>Adventure Setup</h1>
      ...
      <div className="setup-grid" style={{ 
        ...
        {/* Left Column: Left Column: Scenario & Settings */}
        <div className="setup-column" style={{ display: 'flex', flexDirection: 'column', gap: '30px' }}>
          
          {/* Scenario Selector */}
          <div className="setup-section gothic-panel" style={{ padding: '25px', border: '1px solid #444' }}>
            <h3 className="gothic-title" style={{ color: 'var(--color-gold)', marginBottom: '20px', borderBottom: '1px solid #444', paddingBottom: '10px' }}>Select Scenario</h3>
            <div className="scenario-list" style={{ display: 'flex', flexDirection: 'column', gap: '10px', maxHeight: '300px', overflowY: 'auto', paddingRight: '10px' }}>
              {allScenarios.map(s => (
                <div 
                  key={s.id}
            ...
            {selectedScenario && (
              <div className="scenario-preview" style={{ marginTop: '20px', padding: '15px', background: 'rgba(0,0,0,0.3)', borderRadius: '4px', fontStyle: 'italic', fontSize: '0.9rem', color: '#ccc', borderLeft: '3px solid var(--color-gold)' }}>
          ...
          {/* Game Settings */}
          <div className="setup-section gothic-panel" style={{ padding: '25px', border: '1px solid #444' }}>
            <h3 className="gothic-title" style={{ color: 'var(--color-gold)', marginBottom: '20px', borderBottom: '1px solid #444', paddingBottom: '10px' }}>Campaign Rules</h3>
        ...
        <div className="setup-column" style={{ display: 'flex', flexDirection: 'column' }}>
          <div className="setup-section gothic-panel" style={{ padding: '25px', border: '1px solid #444', height: '100%' }}>
            <h3 className="gothic-title" style={{ color: 'var(--color-gold)', marginBottom: '20px', borderBottom: '1px solid #444', paddingBottom: '10px' }}>Assembly of Heroes ({selectedHeroIds.length}/5)</h3>
            ...
            <div className="hero-selection-grid" style={{ 
              ...
              {allHeroes.map(h => {
                ...
                return (
                  ...
                  >
                    <div style={{ height: '160px', background: '#1a1a1a', display: 'flex', alignItems: 'center', justifyContent: 'center', borderBottom: '1px solid #333' }}>
                      <img 
                    ...
                    <div style={{ padding: '15px' }}>
                      <div style={{ fontWeight: 'bold', fontSize: '1.1rem', color: isSelected ? 'var(--color-gold)' : 'white' }}>{h.name}</div>
                      <div style={{ fontSize: '0.8rem', color: 'var(--color-text-dim)' }}>{h.heroClass}</div>
            ...
            {selectedHeroIds.length === 0 && (
              <div style={{ marginTop: '40px', textAlign: 'center', color: '#666', fontStyle: 'italic' }}>
      ...
      <div className="setup-footer" style={{ 
        ...
        <div style={{ textAlign: 'right' }}>
          {!isReady && (
            <div style={{ color: '#ff4444', fontSize: '0.9rem', marginBottom: '10px' }}>
