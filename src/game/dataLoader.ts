...
export class DataLoader {
  ...
  private scenarios: Scenario[] = [
    adventure01 as Scenario,
    adventure02 as Scenario,
    adventure03 as Scenario,
    adventure04 as Scenario,
    adventure05 as Scenario,
    adventure06 as Scenario,
    adventure07 as Scenario,
    adventure08 as Scenario,
    adventure09 as Scenario,
    adventure10 as Scenario,
    adventure11 as Scenario,
    adventure12 as Scenario,
    adventure13 as Scenario,
    scenario1 as Scenario,
    scenario2 as Scenario,
    scenario3 as Scenario,
    scenario4 as Scenario,
    scenario5 as Scenario
  ];
  private cards: Card[] = [
